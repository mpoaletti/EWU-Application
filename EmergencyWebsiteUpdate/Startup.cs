...
namespace EmergencyWebsiteUpdate {
	public class Startup {
		...
		private readonly string _authority = Decryption.DecryptString((String)ConfigurationManager.AppSettings["decryptKey"], (String)ConfigurationManager.AppSettings["okta:OrgUri"]);
